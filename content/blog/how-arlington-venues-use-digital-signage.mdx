...
> **Ready to try it?** [Create your free venue account](https://app.piads.co/sign-up?role=venue_owner) and set up your first screen right now.
...
1. **[Sign up free as a venue owner](https://app.piads.co/sign-up?role=venue_owner)** — no credit card required
...
4. **Optionally earn from ads** — opt into the marketplace when you're ready and keep 70% of ad revenue
