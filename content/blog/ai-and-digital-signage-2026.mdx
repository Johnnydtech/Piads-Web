...
*PiAds handles the scheduling, advertiser matching, and revenue sharing so you can focus on running your venue. [List your screens](https://piads.co) and start earning from local advertisers — free to get started, 70% revenue share to you.*
