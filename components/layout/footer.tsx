...
const footerColumns: { heading: string; links: { name: string; href: string }[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "vs Atmosphere TV", href: "/alternative-to/atmosphere-tv-alternative" },
      { name: "vs UPshow", href: "/alternative-to/upshow-alternative" },
      { name: "vs FRAMEN", href: "/alternative-to/framen-alternative" },
